...
const projectsData = [
  ...
  {
    id: 3,
    title: "Subaru Crosstrek Landing Page Page",
    description: "Designed a Landing Page for the New 2024 Subaru Crosstrek. ",
    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div ref={bioRef} className={`mt-12 transform transition-all duration-1000 delay-200 ${bioVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        <p className="text-lg text-gray-300 leading-relaxed">
          Hi, I'm Zeyad - a passionate UI/UX Designer and Front-end Developer based in the DMV area. I've been crafting beautiful and functional websites since high school, always driven by a desire to push the boundaries of what's possible on the web.
        </p>
